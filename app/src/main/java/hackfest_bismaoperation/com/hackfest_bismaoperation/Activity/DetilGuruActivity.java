...
public class DetilGuruActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Button btnorder;
    boolean flag;
    private String namaDepan,jk,namaBelakang,email,tempatlahir,tanggallahir,alamat;
    ...
    TextView txtnama,txttlp,txttgllahir,txtstatus,txtjk,txtnamaDepan,txtEmail,tempatLahir,txtAlamat;
